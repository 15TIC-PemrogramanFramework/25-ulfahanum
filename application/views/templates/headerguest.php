...
<ul class="nav">
<li><a href="<?php echo base_url().'Home'?>" class="home">Home</a></li>
<li><a href="<?php echo base_url().'Post/postguest'?>" class="home">Dashboard</a></li>
<li><a class="home" href="<?php echo site_url('Home/signup'); ?>">Hi, not a member?</a></li>
</div>  
</ul>
</div>
</div>
